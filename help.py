...
def display_help():
    ...
    grouped_commands = {
        ...
        'Agentic Matrix Commands': [
            ...
            ('/room <agents>: <theme>', 'Temporal nexus in this session (standalone stack: arpahls/rooms).'),
...
**Related repository:** For a **standalone** multi-agent room stack (outside this monolith), see https://github.com/arpahls/rooms — compare when `/room` should stay inside OPSIIE versus when rooms are a separate runtime.
""",
    'video': """
/video <description>
